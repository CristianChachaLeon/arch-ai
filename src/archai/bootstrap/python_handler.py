"""Python Language Handler - Implementación del protocolo LangHandler para Python.

Integra la lógica existente de ast_parser + dependency_resolver en un handler.
"""
...
class PythonLangHandler:
    ...
    excluded_dirs: frozenset[str] = SHARED_EXCLUDED_DIRS
    ...
    def resolve_import(
        ...
        resolved = _resolve_single_import(import_name, files_by_stem, files_by_module, file_path)
